...
curl --request POST --header "Private-Token: $PRIVATE_TOKEN" https://gitlab.com/api/v4/projects/$CI_MERGE_REQUEST_PROJECT_ID/merge_requests/$CI_MERGE_REQUEST_IID/notes --data "Test Comment"
