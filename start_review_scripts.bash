...
curl -X PATCH https://api.heroku.com/apps/$CI_PROJECT_NAME-$CI_COMMIT_REF_SLUG/config-vars -H "Accept: application/vnd.heroku+json; version=3" -H "Authorization: Bearer $HEROKU_API_KEY" -H 'Content-Type: application/json' -d '@/tmp/configs' > /dev/null
