    ...
    let links_area = (
      <div>
        <div style={ S('text-center mt-20 mb-30') }>
          <a href={ `https://${data.brand.subdomain}.chappar.rechat.com/dashboard/mls` } target="_blank" className="btn btn-default" style={ S(`w-280 font-17 p-20 color-fff border-1-solid-${data.brand.primary} bg-${data.brand.primary}`) }>View Exclusive Listings</a>
        </div>
