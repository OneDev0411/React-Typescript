...
export default class Search extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div style={ S(`absolute z-0 t-0 l-0 w-100p h-100p bg-cover bg-center bg-url(${ data.brand ? data.brand.search_bg_image_url : '' })`) }></div>
        ...
        <div style={ S('relative z-2 p-10') }>
          <div style={ S('relative t-190 maxw-770 center-block') }>
            <div style={ S('color-fff text-center font-58 mb-30') } className="tempo">{ data.brand ? data.brand.search_headline : 'We know Dallas.' }</div>
