...
export default class Create extends Component {
  ...
  render() {
    ...
    if (data.signup && data.signup.type === 'agent') {
      agent_button_text = (
        <span><i className="fa fa-check-circle" style={S('color-35b863')} />&nbsp;&nbsp;I'm an agent</span>
      )
      agent_button_style = {
        ...agent_button_style,
        ...button_active_style
    ...
    if (data.signup && data.signup.type === 'client') {
      client_button_text = (
        <span><i className="fa fa-check-circle" style={S('color-35b863')} />&nbsp;&nbsp;I'm a client</span>
      )
      client_button_style = {
        ...client_button_style,
        ...button_active_style
        ...
        <Col sm={7}>
          ...
          <form onSubmit={this.handleSubmit.bind(this)}>
            ...
            <div style={S('relative')}>
              ...
              <i onClick={this.toggleShowPassword} style={S('absolute t-15 r-15 z-100 pointer color-666')} className={`fa fa-eye${data.signup && data.signup.show_password ? '-slash' : ''}`} />
            </div>
            { type_area }
            { message }
            <Button
