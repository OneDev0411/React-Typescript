...
export default class Dashboard extends Component {
  ...
  handleSubmit(e) {
    ...
    criteria.list_volume = {
      min: this.refs.list_volume_min.refs.input.value,
      max: this.refs.list_volume_max.refs.input.value
    }

    criteria.list_value = {
      min: this.refs.list_value_min.refs.input.value,
      max: this.refs.list_value_max.refs.input.value
    }

    criteria.sell_volume = {
      min: this.refs.sell_volume_min.refs.input.value,
      max: this.refs.sell_volume_max.refs.input.value
    }

    criteria.sell_value = {
      min: this.refs.sell_value_min.refs.input.value,
      max: this.refs.sell_value_max.refs.input.value
    }

    criteria.active_volume = {
      min: this.refs.active_volume_min.refs.input.value,
      max: this.refs.active_volume_max.refs.input.value
    }

    criteria.active_value = {
      min: this.refs.active_value_min.refs.input.value,
      max: this.refs.active_value_max.refs.input.value
    }

    criteria.total_active_volume = {
      min: this.refs.total_active_volume_min.refs.input.value,
      max: this.refs.total_active_volume_max.refs.input.value
    }

    criteria.total_active_value = {
      min: this.refs.total_active_value_min.refs.input.value,
      max: this.refs.total_active_value_max.refs.input.value
    }
  ...
  render() {
    ...
    return (
      <div style={ S('w-30p pl-200 pt-10 pull-left bg-F5F5F6 p-5') }>
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          <div>
            ...
            <div>
              <Input type="select" placeholder="Area" ref="area" multiple>
              ...
              <Input type="text" bsSize="small" placeholder="SubArea" ref="subarea"/>
            </div>
          </div>
          ...
          <div>
            <label>
              Active Listings Volume (In the area)
            </label>
            <div>
              <div style={ s } md="6">
                <Input type="text" bsSize="small" placeholder="Min" ref="total_active_volume_min"/>
          ...
          <div>
            <label>
              Active Listings $ Value (In the area)
            </label>
            <div>
              <div style={ s } md="6">
