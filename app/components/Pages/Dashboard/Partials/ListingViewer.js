          ...
          <div style={ S('mt-50 color-bfc3c7 w-100p text-left relative') }>
            ...
            <div style={ S('bg-263445 p-20 w-100p') }>
              ...
              <div style={ S('font-14 mb-5 color-bfc3c7') }>
                <div style={ S('bg-cover bg-url(' + Brand.asset('logo') + ') bg-center w-20 h-20 pull-left mr-10') }></div>
                <div style={ S('pull-left') }>{ Brand.message('title') }</div>
        ...
        <div style={ S('mt-50 color-bfc3c7 w-100p text-left center-block text-center') }>
          ...
          <div style={ S('bg-263445 p-20 w-100p') }>
            ...
            <div style={ S('font-14 mb-15 color-bfc3c7 relative') }>
              <div style={ S('bg-cover bg-url(' + Brand.asset('logo') + ') bg-center w-20 h-20 inline-block mr-10 mt-10') }></div>
              <div style={ S('inline-block relative t-5n') }>{ Brand.message('title') }</div>
              <div className="clearfix"></div>
            </div>
            { phone_area }
            <div style={ S('font-15 mb-5') }>E: { brand_agent.email }</div>
