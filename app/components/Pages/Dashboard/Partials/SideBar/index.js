...
const IntercomCloseButton = ({ onClick }) => (
  <button onClick={onClick} className="intercom__close-btn">
    <svg fill="#333" height="32" viewBox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" /></svg>
  </button>
)
...
const appNavbar = ({
  ...
  return (
    <aside className="c-app-navbar">
      ...
      <ul className="c-app-navbar__list c-app-navbar__list--bottom">
        <NavbarItem title="Notifications">
          <Link to="/dashboard/notifications">
            ...
            <SvgNotifications color={activePath === 'NOTIF' ? ACTIVE_COLOR : DEFAULT_COLOR} />
          </Link>
        </NavbarItem>
      ...
      { window.INTERCOM_ID && <Intercom appID={window.INTERCOM_ID} {...intercomUser} /> }
...
export default compose(
  connect(({ data, user }, { location }) => ({ data, user, activePath: getActivePath(location.pathname) })),
