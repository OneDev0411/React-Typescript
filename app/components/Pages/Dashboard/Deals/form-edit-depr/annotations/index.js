...
class Annotations extends React.Component {
  ...
  renderInput(info) {
    ...
    const onValueUpdate = this.props.onValueUpdate.bind(
      this,
  ...
  renderContext(context, info) {
    ...
    if (item && typeof item === 'object') {text = item.text}

    if (item && typeof item === 'string') {text = item}
  ...
  render() {
    ...
    return (
      <div style={style}>
        ...
        {Object.keys(this._context).map(g =>
          this.renderContext(g, this._context[g])
        )}
