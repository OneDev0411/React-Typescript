...
export const IMAGE_TOOLBAR_BUTTONS_PREFIX = 'rechat'
export const EDIT_IMAGE_TOOLBAR_BUTTON_NAME = `${IMAGE_TOOLBAR_BUTTONS_PREFIX}-image-edit`
export const CHANGE_IMAGE_TOOLBAR_BUTTON_NAME = `${IMAGE_TOOLBAR_BUTTONS_PREFIX}-image-change`
