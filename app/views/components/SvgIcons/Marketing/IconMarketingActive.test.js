...
import Image from './IconMarketingActive.js'
...
describe('IconMarketingActive.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconMarketingActive')
  })
