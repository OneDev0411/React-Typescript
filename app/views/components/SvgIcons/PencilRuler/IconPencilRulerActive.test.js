...
import Image from './IconPencilRulerActive.js'
...
describe('IconPencilRulerActive.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconPencilRulerActive')
  })
