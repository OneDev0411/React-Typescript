...
import Image from './IconMarketingInsightsActive.js'
...
describe('IconMarketingInsightsActive.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconMarketingInsightsActive')
  })
