...
import Image from './IconMarketingInsights.js'
...
describe('IconMarketingInsights.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconMarketingInsights')
  })
