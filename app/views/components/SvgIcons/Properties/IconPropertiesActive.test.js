...
import Image from './IconPropertiesActive.js'
...
describe('IconPropertiesActive.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconPropertiesActive')
  })
