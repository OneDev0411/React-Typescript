...
import Image from './IconOpenHouseOutline.js'
...
describe('IconOpenHouseOutline.svg generated styled component', () => {
  let renderer
  beforeEach(() => {
  ...
  it('sets the correct display name', () => {
    expect(Image.displayName).toEqual('IconOpenHouseOutline')
  })
